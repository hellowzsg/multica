...
export function createEnDict(allowSignup: boolean): LandingDict {
  ...
  features: {
    ...
    runtimes: {
      ...
      description:
        "Local daemons and cloud runtimes, managed from a single panel. Real-time monitoring of online/offline status, usage charts, and activity heatmaps. Auto-detects 16 supported coding tools on your machine.",
      cards: [
        {
        ...
        },
        {
          ...
          description:
            "Multica scans for 16 supported coding tools \u2014 Antigravity, Claude Code, CodeBuddy, Codex, Cursor, Copilot, Gemini, Hermes, Kimi, Kiro CLI, OpenCode, OpenClaw, and Pi (plus internal-only forks: Claude Code Internal, Codex Internal, Gemini Internal) \u2014 and registers a runtime for each one it finds.",
        },
      ],
    },
  },
  ...
  howItWorks: {
    ...
    steps: [
      ...
      },
      {
        ...
        description:
          "Run multica setup \u2014 it walks you through OAuth, starts the daemon, and scans for the 16 supported coding tools (Antigravity, Claude Code, CodeBuddy, Codex, Copilot, Cursor, Gemini, Hermes, Kimi, Kiro CLI, OpenCode, OpenClaw, Pi, and the internal-only forks Claude Code Internal / Codex Internal / Gemini Internal). Whichever ones you already have installed get registered as runtimes automatically.",
      },
      {
    ...
    items: [
      {
        ...
        answer:
          "Multica supports 16 coding tools out of the box: Antigravity, Claude Code, CodeBuddy, Codex, Cursor, Copilot, Gemini, Hermes, Kimi, Kiro CLI, OpenCode, OpenClaw, and Pi, plus the internal-only forks Claude Code Internal, Codex Internal, and Gemini Internal. The daemon auto-detects whichever CLIs you already have installed and registers a runtime for each one. Since it's open source, you can also add your own backends.",
      },
      {
