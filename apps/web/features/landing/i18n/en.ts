    ...
    runtimes: {
      ...
      cards: [
        ...
        },
        {
          ...
          description:
            "Multica scans for 15 supported coding tools \u2014 Claude Code, CodeBuddy, Codex, Copilot, Cursor, Gemini, Hermes, Kimi, Kiro CLI, OpenCode, OpenClaw, and Pi (plus internal-only forks: Claude Code Internal, Codex Internal, Gemini Internal) \u2014 and registers a runtime for each one it finds.",
        },
      ],
    },
  },
